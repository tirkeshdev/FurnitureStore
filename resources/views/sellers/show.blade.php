...
@section('body')
    <div class="ps-5">
        <div class="ps-5">
            <div class="ps-5">
                <div class="ps-5">
                    <div class="card text-center" style="width:40rem;margin:40px 0 48px 0">
                        ...
                        <div class="card-body pb-5">
                            ...
                            <p class="card-text">{{$seller->name}} enjoy generating works of art, which serve to enhance the aesthetic
                                richness and value of daily life. That is, {{$seller->name}}'s art furniture creations are intended—for
                                ...
                                {{$seller->name}}'s great joy in making a piece of furniture is just that—creating—a piece of furniture:
                                ...
                                actual “paper and pencil” design work. (While some of {{$seller->name}}'s work has been influenced by art
                                history, all of the represented works are original designs—generated from within.) Once
                                the design is complete, {{$seller->name}} send it to the client for feedback. Finally, {{$seller->name}} travel to a
                                lumber supplier, where between one and three hours is invested, poring over the
                                available possibilities for a piece. All of this happens before {{$seller->name}} can bring the
